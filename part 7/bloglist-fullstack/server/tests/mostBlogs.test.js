...
describe("most blogs", () => {
    ...
    test('when theres only one blog, the test equals to', () => {
        const result = listHelper(blog);
        expect(result).toEqual({'author': 'David Gvetadze', 'blogs': 1});
    });

    test('when there are more than one blog, the test equals to', () => {
